...
const HelpCenter: FC<IProps> = () => {
  ...
  return (
    <div className='flex-1 flex flex-col'>
      ...
      <div className='overflow-auto help-container' style={{ height: 'calc(100vh - 195px)' }}>
        {/* <Collapse defaultActiveKey={["Guide", "Troubleshooting"]}>
          <Collapse.Panel key='Guide' title='Guide'> */}
        <div className='help-content'>
          <div className='module-title'>Guide</div>
          <Collapse accordion>
            <Collapse.Panel key='1' title='1.What is a crypto wallet address?'>
            ...
            <Collapse.Panel key='2' title='2.How to connect a wallet to Mises Swap'>
            ...
            <Collapse.Panel key='3' title='3.How to switch networks?'>
            ...
            <Collapse.Panel key='4' title='4.How to Swap Tokens'>
            ...
            <Collapse.Panel key='5' title='5.What is a network fee?'>
            ...
            <Collapse.Panel key='6' title='6.What is Price Slippage?'>
            ...
            <Collapse.Panel key='7' title='7.How to disconnect a wallet from Mises Swap'>
        ...
        <div className='help-content'>
          <div className='module-title'>Troubleshooting</div>
          <Collapse accordion>
            <Collapse.Panel key='11' title='1.I accidentally sent funds to the wrong address'>
            ...
            <Collapse.Panel key='12' title='2.My transaction has been pending for a long time. What can I do?'>
              <p className='font-bold mb-5 text-lg'>If you accidentally sent tokens to the wrong address or to a contract address, your tokens may not be recovered.</p>
