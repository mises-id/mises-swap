...
const HelpCenter:FC<IProps> = ()=> {
  ...
  const goToDiscord = () =>{
    window.open('https://discord.gg/pDD3u86S5E', 'target=_blank')
  }
  return (
    <div className='flex-1 flex flex-col'>
      <NavBar onBack={()=>navigate(-1)}><span className='nav-name'>Help Center</span></NavBar>
      <div className='overflow-auto pt-10 help-container' style={{height: 'calc(100vh - 195px)'}}>
        <Collapse defaultActiveKey={["Guide", "Troubleshooting"]}>
          <Collapse.Panel key='Guide' title='Guide'>
            <div className='help-content'>
              <p className='font-bold text-2xl mb-5'>1.What is a crypto wallet address?</p>
              <p className='font-bold mb-5 text-lg'> A crypto wallet address is the public address for your crypto wallet. Your wallet address appears as a randomly generated string of characters.</p>
              ...
              <p className='font-bold text-2xl mb-5'>2.How to connect a wallet to Mises Swap</p>
              <p className='font-bold mb-5 text-lg'>You can connect your cryptocurrency wallet to Mises Swap in a few easy steps.</p>
              ...
              <p className='font-bold text-2xl mb-5'>3.How to switch networks?</p>
              <p className='font-bold mb-5 text-lg'>Mises Swap supports the Ethereum, BNB Chain, Polygon, Optimism, Arbitrum, Avalanche, Fantom, Gnosis, Klaytn, Aurora and zkSync Era networks.</p>
              <p>In order to make a swap or add liquidity to tokens on a different network, you must change the network first.</p>
              <p className='font-bold mb-5 text-lg'>You can change your network by following these steps:</p>
              <ol className="list-decimal">
              ...
              <p className='font-bold text-2xl mb-5'>4.How to Swap Tokens</p>
              <p className='font-bold mb-5 text-lg'>To swap tokens on Mises Swap follow these steps:</p>
              <ol className="list-decimal">
              ...
              <p className='font-bold text-2xl mb-5'>5.What is a network fee?</p>
              <p className='font-bold mb-5 text-lg'>A network fee is the fee paid to the miners of the network you are using for your cryptocurrency transaction. This fee is also known as a gas fee.</p>
              ...
              <p className='font-bold text-2xl mb-5'>6.What is Price Slippage?</p>
              <p className='font-bold mb-5 text-lg'>Price Slippage is the change in token price caused by the total movement of the market.</p>
              ...
              <p className='font-bold mb-5 text-lg'>The minimum amount you receive from a trade is determined by:</p>
              <ol className="list-decimal">
                <li>Market price</li>
              ...
              <p className='font-bold mb-5 text-lg'>You can view the auto slippage setting in two places:</p>
              <ol className="list-decimal">
              ...
              <p className='font-bold text-2xl mb-5'>7.How to disconnect a wallet from Mises Swap</p>
              <p className='font-bold mb-5 text-lg'>You are able to disconnect your wallet from Mises Swap when using it. </p>
              <p className='font-bold mb-5 text-lg'>To disconnect your wallet from the Mises Swap web follow these steps:</p>
              <ol className="list-decimal">
          ...
          <Collapse.Panel key='Troubleshooting' title='Troubleshooting'>
            <div className='help-content'>
              <p className='font-bold text-2xl mb-5'>1.I accidentally sent funds to the wrong address</p>
              <p className='font-bold mb-5 text-lg'>If you accidentally sent tokens to the wrong address or to a contract address, your tokens may not be recovered.</p>
              <p>Once a transaction is completed on the blockchain, it cannot be reversed or refunded.</p>
              <p className='font-bold mb-5 text-lg'>I sent my tokens to the wrong address</p>
              ...
              <p className='font-bold mb-5 text-lg'>I sent my tokens to a contract address</p>
              ...
              <p className='font-bold text-2xl mb-5'>2.My transaction has been pending for a long time. What can I do?</p>
              <p className='font-bold mb-5 text-lg'>If you accidentally sent tokens to the wrong address or to a contract address, your tokens may not be recovered.</p>
              <p className='font-bold mb-5 text-lg'>If your swap transaction has been pending for a long time, you have three available options.</p>
              <ul className='list-outside'>
              ...
              <p className='font-bold text-2xl mb-5'>Why did my transaction fail?</p>
              <p className='font-bold mb-5 text-lg'>here are several reasons why a transaction can fail. Slippage Limits</p>
              ...
              <p className='font-bold mb-5 text-lg'>Insufficient Funds</p>
              <p>The Mises Swap sets a default slippage limit of 0.1%. This slippage limit is the different between your expected output and the real output at the time of your swap. If the real output changes by more than your set slippage, the transaction will fail.</p>
              ...
              <p className='font-bold text-2xl mb-5'>The Mises Swap web app fails to load</p>
              <p className='font-bold mb-5 text-lg'>If you are having trouble loading the Mises Swap web app, there are a few steps you can take to troubleshoot:</p>
              <ol className="list-decimal">
              ...
              <p>If these steps do not work, please reach out to our support team at DisCord channel: <a className="text-blue-600 after:content-['_↗']" href="https://discord.gg/pDD3u86S5E" target="_blank" rel="noreferrer">https://discord.gg/pDD3u86S5E</a></p>
            </div>
          </Collapse.Panel>
        </Collapse>
      </div>
      <div className='flex-none p-10'>
        ...
        <Button block color='primary' onClick={goToDiscord}>
