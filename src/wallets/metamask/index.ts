...
function isMetaMask(ethereum?: WindowProvider): boolean {
...
export const metaMaskWallet = ({
  ...
  projectId,
  ...options
}: MetaMaskWalletOptions & InjectedConnectorOptions): Wallet => {
  const ethereum = window.ethereum as WindowProvider
  const providers = typeof window !== 'undefined' && ethereum?.providers;
