...
const Bonuses: FC = () => {
  return (
    <div className='flex flex-row items-center'>
      ...
      <p className='flex-auto text-[16px] font-200 text-gray-500'>After logging into the Mises wallet to obtain the Mises ID, you will be eligible to earn rewards points by making swap transactions.</p>
    </div>
  )
}
